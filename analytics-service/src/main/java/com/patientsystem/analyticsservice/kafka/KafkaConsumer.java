package com.patientsystem.analyticsservice.kafka;
...
import com.patientsystem.billing.kafka.ChargeEvent;
...
public class KafkaConsumer {
    ...
    public void consumePatientEvent(byte[] event) {
        try {
            ...
            com.patientsystem.analyticsservice.model.PatientEvent entity = new com.patientsystem.analyticsservice.model.PatientEvent();
    ...
    public void consumeChargeEvent(byte[] event) {
        try {
            ...
            com.patientsystem.analyticsservice.model.ChargeEvent entity = new com.patientsystem.analyticsservice.model.ChargeEvent();
            entity.setPatientId(proto.getPatientId());
