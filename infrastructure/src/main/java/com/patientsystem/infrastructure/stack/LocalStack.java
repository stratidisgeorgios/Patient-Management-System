package com.patientsystem.infrastructure.stack;
...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props, final Dotenv dotenv) {
        ...
        FargateService patientService = createFargateService("PatientService", "patient-service:latest", List.of(4000), patientServiceDB, Map.of("BILLING_SERVICE_ADDRESS","host.docker.internal", "BILLING_SERVICE_GRPC_PORT","9001"));
